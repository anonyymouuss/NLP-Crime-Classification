...
data = pd.read_csv('D:/WEB/uploads/sorted_train.csv')  # Provide the correct path to your file
...
output_file = 'processed_categorized_data2.csv'  # You can change the file format to .xlsx if you prefer
